// Xử lý chuyển động vật lý và hình ảnh
const BODIES = [];
const COLLISIONS = []; //sự va chạm
...
/*==============================================*/
// Xử lý mạng, giao tiếp giữa server và client
...
buildStadium();
// Mảng lưu reg của các player hiện tại
let playersReg = {};
// Mảng lưu các player trên server: điểm số, tốc độ tối đa, STT, ...
let serverBalls = {};
// Mảng lưu bóng
let football = {};
// Mảng lưu vị trí bóng
let footballPos = {};
// Số người chơi
...
// Chạy hàm serverLoop 60 lần mỗi giây
...
function connected(socket) {
  ...
  socket.join(roomNo);
  console.log(`New client no.:   ${numberOfClient}, room no.: ${roomNo}`);
...
function serverLoop() {
  // Tương tác của người dùng qua bàn phím
  userInteraction();
